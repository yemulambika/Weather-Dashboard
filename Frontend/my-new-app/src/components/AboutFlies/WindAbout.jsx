...
const WindAbout = () => {
  return (
    <div className="windabout-container">
      ...
      <p>
        The normal unit of wind speed is the <span className="highlight">knot</span> (nautical mile per hour = 0.51 m sec<sup>-1</sup> = 1.15 mph).
      ...
      <p>
        The optimal exposure for the measurement of wind is over level ground of uniform roughness with no large obstacles within 300 m of the tower.
        In practice, few sites in the observing network meet this requirement exactly for all incident wind directions, but most are reasonably representative of an open site.
      </p>
