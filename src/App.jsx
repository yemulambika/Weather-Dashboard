  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/weather" element={isAuthenticated ? <Weather /> : <Navigate to="/" />} />
        <Route path="/humidity" element={isAuthenticated ? <Humidity /> : <Navigate to="/" />} />
        <Route path="/temp" element={isAuthenticated ? <Temp /> : <Navigate to="/" />} />
        <Route path="/wind" element={isAuthenticated ? <Wind /> : <Navigate to="/" />} />
        <Route path="/cloud" element={isAuthenticated ? <Cloud /> : <Navigate to="/" />} />
        <Route path="/pressure" element={isAuthenticated ? <Pressure /> : <Navigate to="/" />} />
