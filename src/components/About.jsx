    ...
    <div className="zigzag-container">
      ...
      <div className="card-about card-left">
        <div className="card-body">
          ...
          The same amount of water vapor results in higher relative humidity in cool air than warm air.
           A related parameter is the dew point. The amount of water vapor needed to achieve saturation increases as the temperature increases. 
           As the temperature of a parcel of air decreases it will eventually reach the saturation point without adding or losing water mass. The amount of water vapor contained within a parcel of air can vary significantly. 
      ...
      <div className="card-about card-right">
        <div className="card-body">
          ...
          <p className="card-text-about">
          Various units are used to express pressure. Some of these derive from a unit of force divided by a unit of area similarly, the pound-force per square inch (psi, symbol lbf/in2) is the traditional unit of pressure in the imperial and US customary systems. Pressure may also be expressed in terms of standard atmospheric pressure; the unit atmosphere (atm) is equal to this pressure, and the torr is defined as 1⁄760 of this.
      ...
      <div className="card-about card-left">
        <div className="card-body">
          ...
          {/* Use NavLink instead of <a> */}
          <NavLink to="/CloudCoverage">Read More about Cloud Coverage...</NavLink>
        </div>
      </div>
    </div>
  );
