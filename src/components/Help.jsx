    ...
    <div className="contact_info_row">
      ...
      <div className="contact_info_item">
        ...
        <div className="contact_info_content">
          ...
          <div className="contact_info_text">ambikayemul2001@gmail.com</div>
        </div>
      </div>
      <div className="contact_info_item">
        <img src={location} alt="Location Icon" className="contact_icon" />
        <div className="contact_info_content">
      ...
      <div className="contact_info_item">
        ...
        <div className="contact_info_content">
          ...
          <div className="contact_info_text">
            <a href="https://github.com/yemulambika">https://github.com/yemulambika</a>
          </div>
        </div>
      </div>
    </div>
              ...
              <div className='contact_form_container py-5'>
                ...
                <form id = 'contact_form'>
                  <div className='contact_form_name d-flex justify-content-between align-items-between'>
                    ...
                    <input type='email' id = 'conatct_form_email' className='contact_form_email input_field' placeholder='Your email' required ='true'/>
                    <input type='number' id = 'conatct_form_phone' className='contact_form_phone input_field' placeholder='Phone No' required ='true'/>
                  </div>
                  <div className='contact_form_text mt-5'>
                    <textarea className='text_field contact_form_message' placeholder='Feedback' cols= "30" rows ="10"></textarea>
                  </div>
